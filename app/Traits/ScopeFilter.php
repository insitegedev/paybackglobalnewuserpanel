...
trait ScopeFilter
{
     ...
     * @return mixed
     */
    public function scopeLastName($query, $surname)
    {
        return $query->whereHas('profile', function ($query) use ($surname) {
     ...
     * @return mixed
     */
    public function scopeModerator($query, $moderator)
    {
        return $query->where('is_moderator', $moderator);
    }
