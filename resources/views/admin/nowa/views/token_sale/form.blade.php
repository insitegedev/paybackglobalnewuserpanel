...
@section('content')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="left-content">
            <span class="main-content-title mg-b-0 mg-b-lg-1">{{$product ? __('admin.token_sale_update') : __('admin.token_sale_create')}}</span>
        </div>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group">
                        <label class="form-label">@lang('admin.total')</label>
                    ...
                    <div class="form-group">
                        <label class="form-label">@lang('admin.raised')</label>
                        <input class="form-control" type="number" name="raised" value="{{$product->raised ?? ''}}">
                        @error('raised')
                        <small class="text-danger">
                            <div class="error">
                                {{$message}}
                    ...
                    <div class="form-group">
                        <label class="form-label">@lang('admin.end_date')</label>
                        <div class="input-group">
                            <div class="input-group-text">
                                @lang('admin.end_date'):
                            </div>
                            <input name="end_date" class="form-control" id="dateMask" placeholder="YYYY-MM-DD" type="text" value="{{$product->end_date ?? ''}}">
                        </div>
                        @error('end_date')
                        <small class="text-danger">
                            <div class="error">
                    ...
                    {{--<div class="form-group">
                        ...
                        <input class="form-control" type="number" name="value" value="{{$product->value ?? ''}}">
                        @error('value')
                        <small class="text-danger">
                            <div class="error">
                                {{$message}}
    ...
    <div class="row">
        <div class="col-lg-12 col-md-12">
            <div class="card">
                <div class="card-body">
                    <div>
                        <h6 class="card-title mb-1">@lang('admin.limits')</h6>
                    </div>
                    <div>
                        <div class="form-group">
                            <table id="options">
                                ...
                                //dd($product->limits);
                                ?>
                                @foreach($product->limits as $item)
                                    <tr>
