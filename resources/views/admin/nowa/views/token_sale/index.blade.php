...
@section('content')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="left-content">
            <span class="main-content-title mg-b-0 mg-b-lg-1">@lang('admin.token_sales')</span>
        </div>
            ...
            <div class="card">
                <div class="card-header pb-0">
                    <div class="d-flex justify-content-between">
                        <h4 class="card-title mg-b-0">@lang('admin.token_sales')</h4>
                    </div>
                                ...
                                @if($data)
                                    @foreach($data as $customer)
                                        <tr>
                                            ...
                                            <td>{{$customer->raised}}</td>

                                            <td>

                                                <a href="{{locale_route('token-sale.edit',$customer->id)}}"
                                                   class="pl-3">
