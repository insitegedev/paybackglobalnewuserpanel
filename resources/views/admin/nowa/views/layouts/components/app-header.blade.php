						...
						<div class="main-header-left ">
							<div class="responsive-logo">
								<a href="{{url('admin')}}" class="header-logo">
									<img src="{{asset('admin_a/assets/img/brand/logo.png')}}" class="mobile-logo logo-1" alt="logo">
									<img src="{{asset('admin_a/assets/img/brand/logo-white.png')}}" class="mobile-logo dark-logo-1" alt="logo">
								</a>
							</div>
								...
								<div class="collapse navbar-collapse" id="navbarSupportedContent-4">
									<ul class="nav nav-item header-icons navbar-nav-right ms-auto">
										...
										<li class="dropdown main-profile-menu nav nav-item nav-link ps-lg-2">
											<a class="new nav-link profile-user d-flex" href="" data-bs-toggle="dropdown"><img alt="" src="{{asset('admin_a/assets/img/faces/2.jpg')}}" class=""></a>
											<div class="dropdown-menu">
