...
@section('content')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="left-content">
            <span class="main-content-title mg-b-0 mg-b-lg-1">@lang('admin.moderators_title')</span>
        </div>
        ...
        <div class="col-xl-12">
            <div class="card">
                <div class="card-header pb-0">
                    ...
                    <a href="{{locale_route('moderator.create')}}" class="btn ripple btn-primary" type="button">@lang('admin.create_btn')</a>
