...
//import img from "../../assets/images/services/4.png";
            ...
            <div className="bg-gray lg:pt-24 pt-16">
                ...
                >
                    <div className="wrapper  flex flex-col justify-between items-start h-full ">
                        ...
                        >
                            ...
                            <span style={{ color: "#08122b" }}>{__("client.nav_service_4", sharedData)}</span>
                        </div>
                        <div className="relative z-10">
                            <div className="text-purple text-xl mb-3 mt-5">{__("client.nav_service_4", sharedData)}</div>
                            <h1 className="sm:text-5xl text-3xl mb-3">{__("client.nav_service_4_subtitle", sharedData)}</h1>
                        </div>
                    </div>
                ...
                <div className="wrapper flex justify-between items-start pb-40 flex-col lg:flex-row">
                    <div className="lg:mr-10 lg:w-2/3 shrink-1">
                        <div className="text-xl mb-5">{__("client.nav_service4_title1", sharedData)}</div>
                        <p className="mb-10">
                            {__("client.nav_service4_text1_p1", sharedData)}
                        </p>
                        <div className="text-xl mb-5">{__("client.nav_service4_title2", sharedData)}</div>
                        <p className="mb-10">
                            {__("client.nav_service4_text2_p1", sharedData)}
                        </p>
                        <p className="mb-10">
                            {__("client.nav_service4_text1_p2", sharedData)}
                        </p>
                        <div className="text-xl mb-5">{__("client.nav_service4_title3", sharedData)}</div>
                        <p className="mb-10">
                            {__("client.nav_service4_text3_p1", sharedData)}
                        </p>
                        <p className="mb-10">
                            {__("client.nav_service4_text3_p2", sharedData)}
                        </p>
                        <p className="mb-10">
                            {__("client.nav_service4_text3_p3", sharedData)}
                        </p>
                    </div>
                    <div className="lg:-mt-52 z010 relative">
                        ...
                        <Link href={route('client.service.show', 2)} className="mb-3 block">
